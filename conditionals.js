...
function drawCard(event) {
    ...
    if(suit === 1)
    {
        if(faceValue === 11)
        {
            $("P#drawCardOutput").text("Jack of clubs");
        }
        else if(faceValue === 12)
        {
            $("P#drawCardOutput").text("Queen of clubs");
        }
        else if(faceValue === 13)
        {
            $("P#drawCardOutput").text("King of clubs");
        }
        else if(faceValue === 1)
        {
            $("P#drawCardOutput").text("Ace of clubs");
        }
        else
        {
            $("P#drawCardOutput").text(`${faceValue} of clubs`);
        }
    }
    else if(suit === 2)
    {
        if(faceValue === 11)
        {
            $("P#drawCardOutput").text("Jack of spades");
        }
        else if(faceValue === 12)
        {
            $("P#drawCardOutput").text("Queen of spades");
        }
        else if(faceValue === 13)
        {
            $("P#drawCardOutput").text("King of spades");
        }
        else if(faceValue === 1)
        {
            $("P#drawCardOutput").text("Ace of spades");
        }
        else
        {
            $("P#drawCardOutput").text(`${faceValue} of spades`);
        }
    }
    else if(suit === 3)
    {
        if(faceValue === 11)
        {
            $("P#drawCardOutput").text("Jack of hearts");
        }
        else if(faceValue === 12)
        {
            $("P#drawCardOutput").text("Queen of hearts");
        }
        else if(faceValue === 13)
        {
            $("P#drawCardOutput").text("King of hearts");
        }
        else if(faceValue === 1)
        {
            $("P#drawCardOutput").text("Ace of hearts");
        }
        else
        {
            $("P#drawCardOutput").text(`${faceValue} of hearts`);
        }
    }
    else if(suit === 4)
    {
        if(faceValue === 11)
        {
            $("P#drawCardOutput").text("Jack of Diamonds");
        }
        else if(faceValue === 12)
        {
            $("P#drawCardOutput").text("Queen of Diamonds");
        }
        else if(faceValue === 13)
        {
            $("P#drawCardOutput").text("King of Diamonds");
        }
        else if(faceValue === 1)
        {
            $("P#drawCardOutput").text("Ace of Diamonds");
        }
        else
        {
            $("P#drawCardOutput").text(`${faceValue} of Diamonds`);
        }
    }
